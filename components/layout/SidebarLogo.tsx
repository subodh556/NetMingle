...
const SidebarLogo = () => {
  ...
  return (
    <div>
      <div onClick={()=>router.push('/')} className="relative rounded-full h-20 w-20 flex items-center justify-center p-4 hover:bg-slate-300 hover:bg-opacity-10 cursor-pointer lg:hidden">
